...
public class Chapter3Test {
    ...
    @DataProvider
    public static Object[][] zipCodesAndPlaces() { //junit dataprovider, pesquisar sobre
        return new Object[][] {
    ...
    @Test
    @UseDataProvider("zipCodesAndPlaces")//testando os 3 casos acima com variaveis. 3 testes e mum
