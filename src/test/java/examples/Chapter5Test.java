...
public class Chapter5Test {
    ...
    public void requestDeZipCode24848_checkThirdPlaceNameInResponseBody_expectKropp() {
        ...
        given().
                ...
                then().
                assertThat().
                body("response.places.place[2].placeName", equalTo("Kropp")); // se colocar o 0 o esperado seria a cidade Alt Bennebek
    }
    ...
    public void requestDeZipCode24848_checkNumberOfPlacesWithStateAbbreviationSH_expect4() {
        ...
        given().
                ...
                log().all().
                assertThat().
                body("response.places.place.findAll{it.stateAbbreviation=='SH'}", hasSize(4));//todos tem abreviação SH, portanto são 4
    }
}
