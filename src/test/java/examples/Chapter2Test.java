...
public class Chapter2Test {
    ...
    public void requestUsZipCode90210_checkContentType_expectApplicationJson() {
        ...
        given().
                ...
                then().
                assertThat().
                contentType(ContentType.JSON);//importante validação se está retornando um json
    }
    ...
    public void requestUsZipCode90210_checkPlaceNameInResponseBody_expectBeverlyHills() {
        ...
        given().
                ...
                log().body().
                assertThat().
                body("places[0].'place name'", equalTo("Beverly Hills")).//JSONPATH
                assertThat().
                body("places[0].'stte'", equalTo("California")); //o zero significa que é o primeiro argumento de elementos places
    }
